...
class RuntimeV0:
    def __init__(self, runtime_dir: str | Path, dialogue_id: str, run_id: str = "run_001") -> None:
        ...
        self.merge_skill = Path("MERGE_MEMORY_SKILL_V0.md").read_text(encoding="utf-8")
        self.update_skill = Path("UPDATE_MEMORY_SPEC.md").read_text(encoding="utf-8")
        self.score_skill = Path("SCORE_MEMORY_SPEC.md").read_text(encoding="utf-8")
...
if __name__ == "__main__":
    runtime = RuntimeV0(runtime_dir="./runtime_state/demo_run_v4", dialogue_id="demo_conv")
    ...
    print("runtime_v0 extended observe-side demo finished")
