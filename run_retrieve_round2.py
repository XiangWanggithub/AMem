...
ALLOWED_TYPES = ["event", "profile", "relation", "preference", "plan", "habit", "state", "temporal", "mixed", "unknown"]
...
RULES = {
    "analyze_query": (
        ...
        "Do not invent alternate label vocabularies such as episodes, facts, or episodic. "
        "Return JSON only."
    ),
...
SCHEMAS = {
    "analyze_query": '{"query_type":"event|profile|relation|preference|plan|habit|state|temporal|mixed|unknown","target_memory_types":["event|profile|relation|preference|plan|habit|state"],"needs_multi_memory":false,"needs_temporal_reasoning":false,"preferred_granularity":"brief|detailed|overview|mixed","recommended_retrieval_route":"time_aware_event_retrieval|profile_memory_retrieval|relation_aware_multi_memory_retrieval|type_aware_retrieval|hybrid_retrieval"}',
...
with open(base / "results/retrieve_skill_test_results_round2.json", "w") as f:
